...
<!--                    <button id="as__btnStart" type="button" class="btn btn-primary">Mulai Ujian</button>-->
...
<!--                btn-control-container-->
                <div class="col-lg-6 col-xl-4 ">
                    ${this.navigator()}
<!--                    <a id="as__linkOtherScripts" href="" class="btn btn-outline-secondary w-100 mt-3">Pilih Naskah Lainnya</a>-->
                </div>
            </div>
        </div>
