          ...
          <form id="formStore" action="{{ $config['form']->action }}" method="POST">
            ...
            @csrf
                <div class="d-flex mb-2 align-items-center">
                    ...
                    <div class="btn-toolbar ms-auto">
                        <div class="btn-group btn-group-sm me-2">
                            <a href="{{ route('panel.examinations.tickets.index',['examination'=>$examination]) }}" class="btn btn-outline-secondary">Batal</a>
                        </div>
                  ...
                  <div id="errorCreate" class="mb-3" style="display:none;">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group mb-3">
                            <label for="code" class="mb-1">Kode Tiket</label>
                            <input type="text" class="form-control" disabled value="{{ $ticket->code }}">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group mb-3">
                            <label for="select2User" class="mb-1">Pemilik Tiket</label>
                            <select id="select2User" type="text" class="form-select" name="owner_id">
