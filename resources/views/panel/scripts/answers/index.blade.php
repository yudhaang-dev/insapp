...
@section('content')
  <div class="d-flex mb-2 align-items-center">
    ...
    <div class="btn-toolbar ms-auto">
      ...
      <div class="btn-group btn-group-sm me-2">
        <a
          href="{{ route('panel.scripts.questions.edit', ['script' => $script['id'], 'question' => $question['id']]) }}"
  ...
  <form id="formStore" method="POST"
        action="{{ route('panel.scripts.questions.answers.store',['script'=>$script, 'question'=>$question]) }}"
