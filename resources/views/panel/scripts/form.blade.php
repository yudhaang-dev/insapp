          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <div class="form-group row mb-3">
                  <label class="control-label col-sm-3 align-self-center mb-0" for="select2Category">Kategori :</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row mb-3">
                  <label class="control-label col-sm-3 align-self-center mb-0" for="select2SubCategory">Sub Kategori :</label>
                  <div class="col-sm-9">
                    <select id="select2SubCategory" name="sub_category_id">
                ...
                <div class="form-group row mb-3">
                  <label class="control-label col-sm-3 align-self-center mb-0" for="select2Category">Demo Naskah Soal :</label>
                  <div class="col-sm-9">
                    <select id="select2ScriptExample" name="example_id">
                      @if(isset($data->example_id))
                        <option value="{{ $data->example_id }}">{{ $data->example->title }}</option>
                      @endif
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row mb-3 {{ !isset($data['introduction']) ? 'd-none' : '' }}">
                  <label class="control-label col-sm-3 align-self-center mb-0" for="e_duration">Waktu CountDown (Detik) :</label>
                  <div class="col-sm-9">
...
@push('script')
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#select2SubCategory').select2({
        dropdownParent: $('#select2SubCategory').parent(),
        placeholder: "Cari Sub Kategori",
        allowClear: true,
        ajax: {
          url: "{{ route('panel.sub-categories.select2') }}",
          dataType: "json",
          cache: true,
          data: function (e) {
            return {
              category_id: $('#select2Category').find(":selected").val() || null,
              q: e.term || '',
              page: e.page || 1
            }
          },
      ...
      $('#select2ScriptExample').select2({
        dropdownParent: $('#select2ScriptExample').parent(),
        placeholder: "Cari Demo Naskah Soal",
        allowClear: true,
        ajax: {
          url: "{{ route('panel.scripts-example.select2') }}",
          dataType: "json",
          cache: true,
          data: function (e) {
            return {
