        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group mb-3">
                  <label for="heading">Tajuk</label>
                  <input id="heading" type="text" class="form-control" name="heading" value="{{ $question->heading ?? '' }}">
                  <div class="invalid-feedback"></div>
                </div>
              </div>
            </div>
            ...
            <div class="table-responsive">
              <table id="dt" class="table table-sm w-100">
                <thead>
                <tr>
