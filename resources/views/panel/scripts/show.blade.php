  ...
  <div class="d-flex mb-2 align-items-center">
    ...
    <div class="btn-toolbar ms-auto">
      <div class="btn-group btn-group-sm me-2">
        <a href="{{ route('panel.scripts.index') }}" class="btn btn-soft-secondary">Kembali</a>
      </div>
      <div class="btn-group btn-group-sm me-2">
        <a href="{{ route('panel.scripts.edit', $script['id']) }}" class="btn btn-soft-secondary">Edit Naskah</a>
      </div>
      <div class="btn-group btn-group-sm">
        <a href="{{ route('panel.scripts.questions.index', $script['id']) }}" class="btn btn-soft-secondary">Kelola
          Butir Soal</a>
      </div>
    </div>
  </div>
