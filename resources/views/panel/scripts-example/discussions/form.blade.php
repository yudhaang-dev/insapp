            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <div class="form-group mb-3">
                  <label for="content">Pembahasan</label>
                  <textarea id="content" class="form-control" name="content">{!! $question->discussion->content ?? '' !!}</textarea>
...
@push('script')
  ...
  <script>
    $(document).ready(function () {
      ...
      let content =  $('#content').summernote({
        height: 200,
        toolbar: [
          ['style', ['style']],
