  ...
  <div class="d-flex mb-2 align-items-center mt-4">
    ...
    <div class="btn-toolbar ms-auto">
      ...
      <div class="btn-group btn-group-sm">
        <a href="{{ route('panel.scripts-example.questions.create',['script'=> $script['id']]) }}" class="btn btn-primary">Tambah</a>
      </div>
    </div>
  </div>
  <div class="card">
          ...
          },
          {
            ...
            render: (data, type, row, meta) => {
              ...
              if (row.discussion !== null) {
                html += `
                  <tr>
                      <td>${decodeHtml(row.discussion.content)}</td>
                  </tr>`;
              }
              return `<table class="table table-sm table-borderless table-striped mt-1">${html}</table>`;
            }
          },
          {
            ...
            <div class="dropdown dropstart">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url()->current() }}/${data}/discussions">Tambah Pembahasan</a></li>
