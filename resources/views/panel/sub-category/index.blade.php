    ...
    <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form id="formStore" method="POST" action="{{ route('panel.sub-categories.store') }}">
            @csrf
            <div class="modal-body">
              ...
              <div class="form-group mb-2">
                ...
                <select id="select2CategoryCreate" name="category_id">
                </select>
              </div>
              <div class="form-group mb-2">
        ...
        <div class="modal-content">
          ...
          <form id="formUpdate" action="#">
            ...
            <div class="modal-body">
              ...
              <div class="form-group mb-2">
                <label>Kategori <span class="text-danger">*</span></label>
                <select id="select2CategoryEdit" name="category_id">
                </select>
              </div>
              <div class="form-group mb-2">
                <label>Nama <span class="text-danger">*</span></label>
  ...
  <script>
    $(document).ready(function () {
      ...
      modalEdit.addEventListener('show.bs.modal', function (event) {
        ...
        let category_id = event.relatedTarget.getAttribute('data-bs-category_id');
        let category_name = event.relatedTarget.getAttribute('data-bs-category_name');
        let optionCategory = new Option(category_name, category_id, false, false);
        $('#select2CategoryEdit').append(optionCategory).trigger('change');
      ...
      $('#select2CategoryCreate').select2({
        dropdownParent: $('#select2CategoryCreate').parent(),
      ...
      $('#select2CategoryEdit').select2({
        dropdownParent: $('#select2CategoryEdit').parent(),
        placeholder: "Cari Kategori",
        allowClear: true,
        ajax: {
          url: "{{ route('panel.categories.select2') }}",
