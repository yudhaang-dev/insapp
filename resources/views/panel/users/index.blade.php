    ...
    <div class="card-header justify-content-between">
      <div class="header-title">
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-6">
            <a href="{{ route('panel.users.create') }}" class="btn btn-primary float-end">
        ...
        columns: [
          {
            ...
            render: function (data, type, full, meta) {
              if (data !== null) {
                return `<img src="/storage/images/thumbnail/${data}" style="max-width:50px; max-height: 50px;">`
              }
              return `<img src="/assets/images/no-content.svg" style="max-width:50px; max-height: 50px;">`
            },
          },
